...
//        processBuilder.command("ping","127.0.0.1");
    ...
    public void testFFmpeg() throws IOException {
        ...
        command.add("-i");
        command.add("D:\\develop\\video\\test\\solr.avi");
        ...
        command.add("-r");
        command.add("18");
        command.add("D:\\develop\\video\\test\\solr.mp4");
    ...
    public void testMp4VideoUtil(){
        ...
        String video_path = "D:\\develop\\video\\test\\solr.avi";
        String mp4_name = "s.mp4";
        String mp4folder_path = "D:\\develop\\video\\test\\";
